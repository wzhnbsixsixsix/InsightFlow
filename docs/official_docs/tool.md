...
URL Source: https://doc.agentscope.io/zh_CN/tutorial/task_tool.html
...
Hide table of contents sidebar
 ...
 [Skip to content](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#furo-main-content)
...
[Back to top](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#)

[View this page](https://doc.agentscope.io/zh_CN/_sources/tutorial/task_tool.rst.txt "View this page")
...
[Go to the end](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#sphx-glr-download-tutorial-task-tool-py) to download the full example code.

工具[¶](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#tool "Link to this heading")
==========================================================================================
...
工具函数[¶](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#id2 "Link to this heading")
-------------------------------------------------------------------------------------------
...
工具模块（Toolkit）[¶](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#toolkit "Link to this heading")
--------------------------------------------------------------------------------------------------------

`Toolkit` 类设计用于管理工具函数，从文档字符串中提取它们的 JSON Schema，并为工具执行提供统一接口。

### 基本用法[¶](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#id3 "Link to this heading")
...
工具响应：
ToolResponse(content=[{'type': 'text', 'text': "正在使用 API 密钥 'xxx' 搜索 'AgentScope'"}], metadata=None, stream=False, is_last=True, is_interrupted=False, id='2026-02-12 10:16:21.951_bbab79')

### 动态扩展 JSON Schema[¶](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#json-schema "Link to this heading")
...
### 中断工具执行[¶](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#id4 "Link to this heading")
...
工具响应：
ToolResponse(content=[{'type': 'text', 'text': '<system-info>The tool call has been interrupted by the user.</system-info>'}], metadata=None, stream=True, is_last=True, is_interrupted=True, id='2026-02-12 10:16:22.955_fe7bb1')
中断标志：
True
...
块 0：
ToolResponse(content=[{'type': 'text', 'text': '1234'}], metadata=None, stream=True, is_last=True, is_interrupted=False, id='2026-02-12 10:16:22.957_9063e7')
中断标志： False

块 1：
ToolResponse(content=[{'type': 'text', 'text': '1234'}, {'type': 'text', 'text': '<system-info>The tool call has been interrupted by the user.</system-info>'}], metadata=None, stream=True, is_last=True, is_interrupted=True, id='2026-02-12 10:16:22.957_9063e7')
中断标志： True

### 自动工具管理[¶](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#id5 "Link to this heading")

[![Image 2: 自动工具管理](https://img.alicdn.com/imgextra/i3/O1CN013cvRpO27MfesMsTeh_!!6000000007783-2-tps-840-521.png)](https://img.alicdn.com/imgextra/i3/O1CN013cvRpO27MfesMsTeh_!!6000000007783-2-tps-840-521.png)
...
### 进一步阅读[¶](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#id6 "Link to this heading")
...
[`Download Jupyter notebook: task_tool.ipynb`](https://doc.agentscope.io/zh_CN/_downloads/c814d0f0885573dcc616fd38c752cf4e/task_tool.ipynb)

[`Download Python source code: task_tool.py`](https://doc.agentscope.io/zh_CN/_downloads/6f4c306463d5cc9a71271ea912c1f13b/task_tool.py)

[`Download zipped: task_tool.zip`](https://doc.agentscope.io/zh_CN/_downloads/f963267f1516b18888561472e1f1380f/task_tool.zip)

[Gallery generated by Sphinx-Gallery](https://sphinx-gallery.github.io/)

[Next MCP](https://doc.agentscope.io/zh_CN/tutorial/task_mcp.html)[Previous 长期记忆](https://doc.agentscope.io/zh_CN/tutorial/task_long_term_memory.html)
...
*   [工具](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#)
    *   [工具函数](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#id2)
    *   [工具模块（Toolkit）](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#toolkit)
        *   [基本用法](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#id3)
        *   [动态扩展 JSON Schema](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#json-schema)
        *   [中断工具执行](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#id4)
        *   [自动工具管理](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#id5)
        *   [进一步阅读](https://doc.agentscope.io/zh_CN/tutorial/task_tool.html#id6)